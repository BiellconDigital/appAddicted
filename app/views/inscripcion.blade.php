...
@section('content')
    ...
    {{ Form::model($user, array('route' => array('inscripcion.update', $user->id), "role" => "form")) }}
        <div id="formInscripcion">
            ...
            <div class="form-group">
		{{ Form::select('form_pais', $paises, Input::old("form_pais"), ["placeholder" => "País", "class" => "form-control"]) }}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="checkbox text-white">
                    ...
                    He leído los Términos y codinciones de uso y estoy de acuerdo.
                </div>
            </div>
        ...
        <div class="form-group text-center">
            <br/><br/>
            <button type="submit" class="boton text-center">Continúa <i class=""><img src="{{asset('img/icono-enviar.png')}}" width="30" /></i></button>
        </div>
    {{ Form::close() }}
